...
# Carpeta de Drive donde se guarda cada Excel semanal de instalaciones con las
# columnas de viabilidad (ver src/lib/viabilidadExcel.ts). Sin esta variable,
# el formulario de viabilidad sigue funcionando igual, solo que no se guarda
# copia del Excel en Drive.
GOOGLE_DRIVE_INSTALACIONES_CARPETA_ID=...
```
